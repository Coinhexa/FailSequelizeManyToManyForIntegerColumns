...
export default class RoleRepository {
  ...
  static async update(updateBody: { roleId: number; name: string; users: User[] }) {
    return this.partialUpdate(updateBody);
  }

  static async partialUpdate(updateBody: { roleId: number; name?: string; users?: User[] }) {
  ...
  static async destroy(roleId: number) {
